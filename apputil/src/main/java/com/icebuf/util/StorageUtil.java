...
public class StorageUtil {
    ...
    public static class StorageVolumeCompat {
        ...
        public StorageVolumeCompat(StorageVolume volume, List<?> volumeInfos) {
            mId = ReflectUtil.get(volume, mIdField);
            mPath = ReflectUtil.get(volume, mPathField);
            mDescription = ReflectUtil.get(volume, mDescriptionField);
        ...
        private File getInternalPath(StorageVolume volume, List<?> volumeInfos) {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.P){
                return ReflectUtil.get(volume, mInternalPathField);
            }
            String path = ReflectUtil.get(volumeInfos, mVIInternalPathField);
                ...
                for (Object obj : volumeInfos) {
                    try {
                        ...
                        if(mPath.getPath().equals(path)) {
                            return ReflectUtil.get(obj, field);
                        }
        ...
        public static String getState(StorageVolume volume) {
            ...
            return ReflectUtil.get(volume, mStateField);
        }
        ...
        public static String getUuid(StorageVolume volume) {
            ...
            return ReflectUtil.get(volume, mFsUuidField);
        }
        ...
        public static boolean isEmulated(StorageVolume volume) {
            ...
            return ReflectUtil.getBoolean(volume, mEmulatedField);
        }
        ...
        public static boolean isRemovable(StorageVolume volume) {
            ...
            return ReflectUtil.getBoolean(volume, mRemovableField);
        }
        ...
        public static boolean isPrimary(StorageVolume volume) {
            ...
            return ReflectUtil.getBoolean(volume, mPrimaryField);
        }
    }
