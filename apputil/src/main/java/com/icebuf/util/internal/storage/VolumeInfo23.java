...
package com.icebuf.util.internal.storage;
 ...
 * @hide
 */
public class VolumeInfo23 implements Parcelable {
    ...
    private static final Comparator<VolumeInfo23>
            sDescriptionComparator = new Comparator<VolumeInfo23>() {
        @Override
        public int compare(VolumeInfo23 lhs, VolumeInfo23 rhs) {
            if (VolumeInfo23.ID_PRIVATE_INTERNAL.equals(lhs.getId())) {
                return -1;
    ...
    static {
        sStateToEnvironment.put(VolumeInfo23.STATE_UNMOUNTED, Environment.MEDIA_UNMOUNTED);
        sStateToEnvironment.put(VolumeInfo23.STATE_CHECKING, Environment.MEDIA_CHECKING);
        sStateToEnvironment.put(VolumeInfo23.STATE_MOUNTED, Environment.MEDIA_MOUNTED);
        sStateToEnvironment.put(VolumeInfo23.STATE_MOUNTED_READ_ONLY, Environment.MEDIA_MOUNTED_READ_ONLY);
        sStateToEnvironment.put(VolumeInfo23.STATE_FORMATTING, Environment.MEDIA_UNMOUNTED);
        sStateToEnvironment.put(VolumeInfo23.STATE_EJECTING, Environment.MEDIA_EJECTING);
        sStateToEnvironment.put(VolumeInfo23.STATE_UNMOUNTABLE, Environment.MEDIA_UNMOUNTABLE);
        sStateToEnvironment.put(VolumeInfo23.STATE_REMOVED, Environment.MEDIA_REMOVED);
        sStateToEnvironment.put(VolumeInfo23.STATE_BAD_REMOVAL, Environment.MEDIA_BAD_REMOVAL);
...
//        sStateToDescrip.put(VolumeInfo23.STATE_UNMOUNTED, R.string.ext_media_status_unmounted);
//        sStateToDescrip.put(VolumeInfo23.STATE_CHECKING, R.string.ext_media_status_checking);
//        sStateToDescrip.put(VolumeInfo23.STATE_MOUNTED, R.string.ext_media_status_mounted);
//        sStateToDescrip.put(VolumeInfo23.STATE_MOUNTED_READ_ONLY, R.string.ext_media_status_mounted_ro);
//        sStateToDescrip.put(VolumeInfo23.STATE_FORMATTING, R.string.ext_media_status_formatting);
//        sStateToDescrip.put(VolumeInfo23.STATE_EJECTING, R.string.ext_media_status_ejecting);
//        sStateToDescrip.put(VolumeInfo23.STATE_UNMOUNTABLE, R.string.ext_media_status_unmountable);
//        sStateToDescrip.put(VolumeInfo23.STATE_REMOVED, R.string.ext_media_status_removed);
//        sStateToDescrip.put(VolumeInfo23.STATE_BAD_REMOVAL, R.string.ext_media_status_bad_removal);
    }
    ...
    public VolumeInfo23(String id, int type, DiskInfo disk, String partGuid) {
    ...
    public VolumeInfo23(Parcel parcel) {
    ...
    public static @NonNull Comparator<VolumeInfo23> getDescriptionComparator() {
...
//        final StorageManager storage = (StorageManager) context.getSystemService(Context.STORAGE_SERVICE);
//
...
//            emulated = true;
//
//            final VolumeInfo23 privateVol = storage.findPrivateForEmulated(this);
//            if (privateVol != null) {
...
//    }
    ...
    public boolean equals(Object o) {
        if (o instanceof VolumeInfo23) {
            return Objects.equals(id, ((VolumeInfo23) o).id);
        } else {
            return false;
        }
    }
    ...
    public static final Creator<VolumeInfo23> CREATOR = new Creator<VolumeInfo23>() {
        @Override
        public VolumeInfo23 createFromParcel(Parcel in) {
            return new VolumeInfo23(in);
        }

        @Override
        public VolumeInfo23[] newArray(int size) {
            return new VolumeInfo23[size];
        }
    };
